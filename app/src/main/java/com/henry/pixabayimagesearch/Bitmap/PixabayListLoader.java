...
package com.henry.pixabayimagesearch.Bitmap;
...
import com.henry.pixabayimagesearch.Adapter.PixabayListAdapter.ViewHolder;

import uk.co.senab.bitmapcache.BitmapLruCache;
import uk.co.senab.bitmapcache.CacheableBitmapDrawable;

public class PixabayListLoader extends SimpleItemLoader<String, CacheableBitmapDrawable> {
    final BitmapLruCache mCache;

    public PixabayListLoader(BitmapLruCache cache) {
        mCache = cache;
    }
